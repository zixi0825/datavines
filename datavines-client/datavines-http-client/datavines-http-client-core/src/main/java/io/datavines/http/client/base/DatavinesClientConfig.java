...
public class DatavinesClientConfig {
    ...
    public static final String CLIENT_RETRY_TIMES = "datavines.client.retryTimes";
    public static final String CLIENT_SLEEP_BETWEEN_RETRY = "datavines.client.sleep.betweenRetry";
}
