package io.datavines.pipeline.plugin.dolphinscheduler;
...
public class DolphinSchedulerPipelineFetcher implements PipelineFetcher {
    ...
    public PipelineDataResponse fetchData(FetchDataParam param) {
        ...
        pipelineDataResponse.setResponseDataList(query(jdbcTemplate, sql, 100));
    ...
    private ListWithQueryColumn query(JdbcTemplate jdbcTemplate, String sql, int limit) {
