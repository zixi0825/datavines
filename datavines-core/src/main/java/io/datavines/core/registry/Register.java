 ...
 */
package io.datavines.core.registry;
...
public class Register {
    ...
    public void start() {
        registry.subscribe("", event -> {
            if (Event.Type.REMOVE == event.type()) {
                try {
                    ...
                    FailoverManager.getInstance().handleFailover(event.key());
                } finally {
        ...
        try {
            ...
            FailoverManager.getInstance().handleFailover(host);
            ...
            FailoverManager.getInstance().handleFailover(activeServerList);
